...
export const DEFAULT_READ_ONLY_LIVE_COLLECTION_HANDLES = Object.freeze([
  "test",
  // Legacy curated collection retained on Shopify by the storefront/app. Its
  // membership is not generated by the canonical taxonomy rules, so preserve
  // it as read-only until an explicit migration plan is approved.
  "beauty-bestsellers",
]);
